...
namespace Phoenix.NET.Client.ConsoleApplicationTest
{
    internal class Program
    {
        ...
        static PhoenixClientNode actorNode;
        ...
        private static async void PerfTest()
        {
            ...
            PhoenixClientConfig config = new PhoenixClientConfig
            {
                Hostname = "127.0.0.1",
                Port = 22000,
            };

            actorNode = new PhoenixClientNode();
            ...
            Task<Common.IDisposableSubscription> asyncSubscription = null;
            ...
            Common.IDisposableSubscription subscription = await asyncSubscription;
