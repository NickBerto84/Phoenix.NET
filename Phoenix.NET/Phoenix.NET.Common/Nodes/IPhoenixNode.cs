...
namespace Phoenix.NET.Common.Nodes
{
    ...
    /// </summary>
    public interface IPhoenixNode : IDisposable
    {
        /// <summary>
        /// Id of this node.
        /// </summary>
    ...
    /// <param name="hook">Phoenix context hook for other information.</param>
    public delegate void ContentHandler(object content, PhoenixContextHook hook);
}
