...
namespace Phoenix.NET.Common.Collections
{
    /// <summary>
    /// Implementation of IChannelsSubscriptionsDictionary.
    /// </summary>
    /// <typeparam name="T">The subscription type.</typeparam>
    public class PhoenixChannelsSubscriptionsDictionary<T> : IChannelsSubscriptionsDictionary<T>
    {
        /// <summary>
    ...
    class ChannelTreeNode<T>
    {
        ...
        /// <summary>
        /// The name of the channel this node represents. Uses PhoenixChannelsSubscriptionsDictionary.ChannelsSeparator to build the string.
        /// </summary>
        public string FullName => $"{Parent?.FullName}{PhoenixChannelsSubscriptionsDictionary<T>.ChannelsSeparator}{Name}";

        /// <summary>
        /// Set of items that are subscribed to this channel.
        /// </summary>
        public PhoenixConcurrentHashSet<T> Items { get; } = new PhoenixConcurrentHashSet<T>();
