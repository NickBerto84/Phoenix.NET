...
namespace Phoenix.NET.Common.Collections
{
    ...
    public class PhoenixConcurrentHashSet<T> : IEnumerable<T>
    {
        ...
        /// <summary>
        /// Enumerator of PhoenixConcurrentHashSet
        /// </summary>
        /// <typeparam name="U">The type of the PhoenixConcurrentHashSet.</typeparam>
        public class Enumerator<U> : IEnumerator<U>, IDisposable, IEnumerator
        {
            private PhoenixConcurrentHashSet<U> _concurrentHashSet;
            ...
            internal Enumerator(PhoenixConcurrentHashSet<U> concurrentHashSet)
            {
